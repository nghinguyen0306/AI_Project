  ...
  return (
    <div className="home-container">
      ...
      <section className="service-info">
        <h2>Our service</h2>
        <p>We provide a tool for translating sign language into automatic subtitles, helping content creators add subtitles to their YouTube videos more easily and quickly.</p>
