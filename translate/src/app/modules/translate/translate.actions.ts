...
export class SetSignedLanguageInput {
  static readonly type = '[Translate] Set Signed Language Input';
  constructor(public signText: string) {}
}

export class SetTranslatedSpokenText {
  static readonly type = '[Translate] Set Translated Spoken Text';
  constructor(public translatedText: string) {}
}
